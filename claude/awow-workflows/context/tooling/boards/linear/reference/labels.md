...
Prefix scheme: <the prefixes observed, e.g. type:* / area:*> (per `context/team/conventions/REQUIRED/labels.md`).

In use today:
- type:* — <list>
- area:* — <list>
- status:* — <list; leave the line out when the board has none>
