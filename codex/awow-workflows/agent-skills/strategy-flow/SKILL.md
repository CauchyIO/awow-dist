...
- Settle the board with the `board-target` skill, read `{ANCHOR}/context/tooling/board.md` for the board pointer and read surface, then read the live board: active projects and current engagements.
