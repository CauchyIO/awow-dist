...
- `{HUB}/context/tooling/design-system.md`, falling back to `${CLAUDE_PLUGIN_ROOT}/context/tooling/design-system.md` — if `mode:` is not `absent`, any HTML artefact this flow produces (Phase 3.1 presentation track) must adopt it
