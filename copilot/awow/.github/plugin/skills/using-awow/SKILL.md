...
Reach for the catalog before hand-rolling: your skill listing, or `${CLAUDE_PLUGIN_ROOT}/context/tooling/command-catalog.md`, which lists every command and the plugin it ships in.
