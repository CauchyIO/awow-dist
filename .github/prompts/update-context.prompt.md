...
phase: standardise
prerequisites:
  - "Team context exists under {HUB}/context/team/ — this command updates existing destinations and never invents a new category"
...
**Paths.** Convention, style, and meeting destinations are team data: `{HUB}` only, no fallback,
...
`{HUB}/context/team/style/`, and `{HUB}/context/team/meetings/`, and read any file
