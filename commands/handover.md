...
phase: standardise
argument-hint: "[who it is for, e.g. 'my morning read' or 'another agent to challenge the design'] (optional — omit and you will be asked)"
prerequisites:
  - "A session carrying something that would be lost: decisions taken, state changed, or findings that exist only in this context."
removes_pain: "the next reader re-deriving what this session already knew"
---
